      ...
      <header className="fixed top-0 left-0 right-0 z-40 backdrop-blur-md bg-background/80 border-b border-border/50">
        <div className="container max-w-6xl flex items-center justify-between py-6">
          ...
          <nav className="hidden md:flex items-center gap-2 text-sm font-medium">
            <a href="#services" className="px-4 py-2 rounded-full bg-sage/15 hover:bg-sage/30 text-foreground transition-colors backdrop-blur-sm">Услуги</a>
            <a href="#catalog" className="px-4 py-2 rounded-full bg-sage/15 hover:bg-sage/30 text-foreground transition-colors backdrop-blur-sm">Каталог</a>
            <a href="#about" className="px-4 py-2 rounded-full bg-sage/15 hover:bg-sage/30 text-foreground transition-colors backdrop-blur-sm">О нас</a>
            <a href="#contacts" className="px-4 py-2 rounded-full bg-sage/15 hover:bg-sage/30 text-foreground transition-colors backdrop-blur-sm">Контакты</a>
          </nav>
