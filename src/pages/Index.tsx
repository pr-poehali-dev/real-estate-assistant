        ...
        <div className="container max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-4">Мы — динамично развивающееся агентство, работающее на рынке услуг по подбору недвижимости с 2025 года. За это время мы успешно реализовали множество проектов разного масштаба и уровня сложности.</p>
              <p className="text-lg text-muted-foreground mb-4">
                Образование компании стало логическим продолжением успешного завершения финансовых сделок группой специалистов, ставших основой нашего коллектива.
              </p>
