    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-40 backdrop-blur-md bg-background/80 border-b border-border/50">
        <div className="container max-w-6xl flex items-center justify-between py-4">
          ...
          <a href="/for-client" className="px-4 py-2 rounded-full bg-muted text-foreground hover:bg-muted/70 transition-colors text-sm font-medium">Клиентам</a>
        </div>
      </header>
      ...
      <section id="contacts" className="py-24 px-4">
        <div className="container max-w-5xl">
          <div className="relative bg-terracotta rounded-[3rem] p-10 md:p-16 text-center overflow-hidden px-16 mx-[75px] my-0 py-[25px]">
