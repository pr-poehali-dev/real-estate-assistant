...
const DIRECTIONS = [
  ...
  { icon: 'Trees',     title: 'Загородная',  text: 'Дома, коттеджи, особняки, усадьбы, резиденции, таунхаусы, дуплексы — подберём лучший вариант за городом.', tags: ['Дома', 'Коттеджи', 'Особняки', 'Усадьбы', 'Резиденции', 'Таунхаусы', 'Дуплексы'] },
];
