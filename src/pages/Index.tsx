...
const LOGO =
  'https://cdn.poehali.dev/projects/ab7a83ba-e182-427f-8219-a315e20c4c4a/bucket/832e771e-d226-4440-9c86-a4f218b5b245.png';
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-40 backdrop-blur-md bg-background/80 border-b border-border/50">
        <div className="container max-w-6xl flex items-center justify-between py-2">
          <a href="#" className="flex items-center">
            <img src={LOGO} alt="Дом Мечты" className="h-24 w-auto" />
          </a>
