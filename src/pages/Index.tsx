        ...
        <div className="container max-w-6xl relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-up">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button onClick={() => openRequest('meeting')} size="lg" variant="outline" className="rounded-full px-8 h-14 text-base border-2 border-terracotta text-terracotta hover:bg-terracotta/15 hover:text-terracotta">
