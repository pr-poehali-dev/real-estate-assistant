        ...
        <div style={{ position:'relative', zIndex:2, width:'100%', maxWidth:1200, margin:'0 auto', padding:'clamp(100px,14vh,140px) clamp(24px,6vw,80px) clamp(60px,8vh,100px)' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'auto 1fr', gap:'clamp(32px,5vw,72px)', alignItems:'start' }} className="hero-grid">
            ...
            <div>
              ...
              <p className="animate-fade-up text-right px-0 py-0 my-[18px] mx-[17px]" style={{ animationDelay:'440ms', fontFamily:'Inter,sans-serif', fontWeight:300, fontSize:'clamp(13px,1.2vw,15px)', lineHeight:1.85, color:MUTED, maxWidth:480, marginBottom:36 }}>Профессионально подберем недвижимость. 
